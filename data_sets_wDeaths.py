...
def create_case_df_county():
    ...
    data['death_rate'] = data['deaths'].groupby(level=0).diff()
    ...
    nan_vals_deaths = data['death_rate'].isnull()
    data.loc[nan_vals_deaths, 'death_rate'] = data.loc[nan_vals_deaths, 'deaths']
    data[['cases', 'deaths', 'case_rate', 'death_rate']] = data[['cases',
                                                                 'deaths',
                                                                 'case_rate',
                                                                 'death_rate'
                                                                 ]].astype(
